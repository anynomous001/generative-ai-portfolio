...
/> */}
       ...
       <div className="min-h-[calc(100dvh-64px)] relative overflow-hidden border-2 border-solid border-white/10">
...
>
  My <span className="ml-1 font-bold"
    ...
    > Experience</span>
</h1>        <p className="lead mt-2">A concise look at my professional journey.</p>
        <div className="mt-8">
